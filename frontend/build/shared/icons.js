...
(function (global) {
  ...
  var ICONS = {
    ...
    'speaker': '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor" aria-hidden="true" focusable="false"><path fill-rule="evenodd" d="M8 2.8H16A3 3 0 0 1 19 5.8V18.2A3 3 0 0 1 16 21.2H8A3 3 0 0 1 5 18.2V5.8A3 3 0 0 1 8 2.8ZM7.8 14.2a4.2 4.2 0 1 0 8.4 0 4.2 4.2 0 1 0-8.4 0Z"/><circle cx="12" cy="14.2" r="2.1"/><circle cx="12" cy="6.6" r="1.55"/></svg>',
    ...
    'disc': '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor" aria-hidden="true" focusable="false"><path fill-rule="evenodd" d="M3 12a9 9 0 1 0 18 0 9 9 0 1 0-18 0ZM8.6 12a3.4 3.4 0 1 1 6.8 0 3.4 3.4 0 1 1-6.8 0Z"/><circle cx="12" cy="12" r="1.15"/></svg>',
    ...
    'radio': '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor" aria-hidden="true" focusable="false"><path fill-rule="evenodd" d="M5.6 8.4H18.4A3 3 0 0 1 21.4 11.4V17.6A3 3 0 0 1 18.4 20.6H5.6A3 3 0 0 1 2.6 17.6V11.4A3 3 0 0 1 5.6 8.4ZM13.3 14.5a3.1 3.1 0 1 0 6.2 0 3.1 3.1 0 1 0-6.2 0ZM6.55 11.6H10.85A.95.95 0 0 1 10.85 13.5H6.55A.95.95 0 0 1 6.55 11.6Z"/><path d="M7.4 8.4l9.4-4.8" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>',
